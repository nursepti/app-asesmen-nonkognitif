...
import { Role, StatusJadwal } from '@prisma-client';
...
//   const tipe    = ['A', 'B', 'C', 'D', 'E']; // Tipe Kelas
...
//     }
//   }
//   console.log(`✅ ${kelases.length} Kelas berhasil dibuat (7A - 9E).`);
...
//     const targetKelas = kelases[(i - 1) % kelases.length];
